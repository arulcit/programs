val = '''A man, a plan, a cameo, Zena, Bird, Mocha, Prowel, a rave,
...
for i in xrange(b-1,-1,-1):
    if val[i] != val[rightstart]:
        print "Not matching characters are '%s' at index %d and '%s' at index '%d'" % (val[i], i, val[rightstart],rightstart)
        flag = False
        break
    rightstart += 1
